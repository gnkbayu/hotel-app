...
<div class="wrapper">
 ...
 @include('Template.sidebar')
  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      <div class="container-fluid">
      <a href="{{ url('fasilitas/create') }}" class="btn btn-primary mb-3">Tambah</a>
      <div class="card">
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <td>
                        <a href="{{ url('fasilitas/'. $value->id.'/edit') }}" class="btn btn-info">edit</a>
                    </td>
                    <td>
                        <form action="{{ url('fasilitas/'. $value->id) }}" method="POST">
                        @csrf
